...
public class BatchService {
	...
	public Batch createEntity(Batch entity) {
		Program program =progRepository.findById(entity.getBatch_program_id()).orElseThrow(() -> new RuntimeException("Program not found"));
    ...
    public Batch updateEntity(Integer id, Batch entity) {
        ...
        Program program = progRepository.findById(entity.getBatch_program_id())
                .orElseThrow(() -> new ResourceNotFoundException("Program with ID " + entity.getBatch_program_id() + " not found"));
